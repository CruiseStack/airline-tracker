...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        self.stdout.write(self.style.SUCCESS('Creating sample flight data...'))
        ...
        for airline_data in airlines_data:
            ...
            if created:
                self.stdout.write(f'Created airline: {airline.name}')
        ...
        for airport_data in airports_data:
            ...
            if created:
                self.stdout.write(f'Created airport: {airport.name}')
        ...
        self.stdout.write(
            self.style.SUCCESS(
                f'Successfully created {flight_count} flights for the next 7 days!'
            )
        )
        self.stdout.write(
            self.style.SUCCESS(
                f'Total Airlines: {Airline.objects.count()}'
            )
        )
        self.stdout.write(
            self.style.SUCCESS(
                f'Total Airports: {Airport.objects.count()}'
            )
        )
        self.stdout.write(
            self.style.SUCCESS(
